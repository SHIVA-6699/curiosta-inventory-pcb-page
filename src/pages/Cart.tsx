...
const Cart = () => {
    return (
        <>
        <div className=" grid grid-cols-1 gap-y-5   p-4 w-full sm:w-1/2" > 
        <TopNavbar />
        <div/>
        <div className="my-2 text-center">
            <Typography size="h5/normal" className={"font-semibold"}>Cart</Typography>
        </div>

        <h1 className="p-2 text-white bg-blue-700 border  w-36  headers">Issue Requests</h1>
     ...
     <div className={"grid grid-cols-2 justify-items-center "}>
      ...
      <p className={"text-sm"}>RES 0 OHM JUMPER 1/4W 1206</p>
        </div>
        <div className={"flex flex-wrap ml-10"}>
        <CartNumber></CartNumber>
        </div>
            </div>
            <hr class="h-px w-80 mt-3 bg-gray-200 border-0 dark:bg-gray-700"></hr>
            {/* cart item 2 */}
             <div className={"grid grid-cols-2 justify-items-center"}>
      ...
      <p className={"text-sm"}>RES 0 OHM JUMPER 1/4W 1206</p>
        ...
        <CartNumber></CartNumber>
            ...
            <h2 className="p-2 text-white bg-yellow-600 w-20 headers">Borrow</h2>
            {/* cart 4 */}
               <div className={"grid grid-cols-2 justify-items-center"}>
